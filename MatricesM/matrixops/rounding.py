def rnd(mat,n,dec,obj,m,dFrame):
    ...
    if mat._dfMat:
        ...
        return obj(mat.dim,data=temp,features=mat.features[:],decimal=dec,dtype=dFrame,index=mat.index[:],indexname=mat.indexname,implicit=True) 
...
def flr(mat,obj,m,dFrame):
    if mat._dfMat:
        ...
        return obj(mat.dim,data=temp,features=mat.features[:],decimal=0,dtype=dFrame,index=mat.index[:],indexname=mat.indexname,implicit=True) 
    if mat._cMat:
